...
var useNewMessageNotification = function useNewMessageNotification(_ref) {
  var onMessageNew = _ref.onMessageNew,
    onNewMessageNotification = _ref.onNewMessageNotification,
  ...
  (0, _react.useEffect)(function () {
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              console.warn('onMessageNew is deprecated and will be removed in future release. Please use onNewMessageNotification to establish the same behaviour');
              _context.next = 14;
              break;
            case 5:
    ...
    var listener = client == null ? void 0 : client.on('notification.message_new', handleEvent);
    return function () {
